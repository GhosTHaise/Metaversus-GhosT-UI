  ...
  <section className={`${styles.paddings} relative z-10`}>
     ...
     >
        ...
        >
            ...
            <div className="absolute bottom-20 right-20 w-[70px] z-[70px] p-[6px] rounded-full
                     bg-[#5d6680]
            ">
                  <img src="people-01.png" alt="people1" className="w-full h-full" />
            </div>
            <div className="absolute top-10 left-20 w-[70px] z-[70px] p-[6px] rounded-full
                     bg-[#5d6680]
            ">
                  <img src="people-02.png" alt="people2" className="w-full h-full" />
            </div>
            <div className="absolute top-1/2 left-[45%] w-[70px] z-[70px] p-[6px] rounded-full
                     bg-[#5d6680]
            ">
